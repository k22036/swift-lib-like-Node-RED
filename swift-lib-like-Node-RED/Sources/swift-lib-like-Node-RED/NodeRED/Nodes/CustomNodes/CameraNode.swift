...
public final class CameraNode: NSObject, Codable, Sendable, Node {
    ...
    public func initialize(flow: Flow) async {
    ...
    public func receive(msg: NodeMessage) {
        // No input handling
    }

    public func send(msg: NodeMessage) async {
